(function webpackUniversalModuleDefinition(root, factory) {
    ...
    if (typeof exports === 'object' && typeof module === 'object')module.exports = factory(); else if (typeof define === 'function' && define.amd)define("Barba", [], factory); else if (typeof exports === 'object')exports["Barba"] = factory(); else
        root["Barba"] = factory();
})(this, function () {
    return (function (modules) {
        ...
        var Utils = {
            getCurrentUrl: function () {
                ...
                return url.replace(/#.*/, '');
            }, xhrTimeout: 5000, xhr: function (url) {
        ...
        var Utils = __webpack_require__(5);
        var BaseView = {
            namespace: null, extend: function (obj) {
                return Utils.extend(this, obj);
            }, init: function () {
                var _this = this;
        ...
        var HistoryManager = {
            history: [], add: function (url, namespace) {
