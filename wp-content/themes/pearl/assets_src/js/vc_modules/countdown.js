    ...
    $(document).ready(function () {
        $('.stm_countdown .stm_countdown-container').each(function () {
            ...
            $(this).countdown(dateStart, function (event) {
                ...
                var str = '' +
                    '<div class="counter">' +
                    '<span class="counter__label">' + days_plural + '</span>' +
                    '<span class="counter__value">%D</span>' +
                    '</div>' +
                    '<div class="counter">' +
                    '<span class="counter__label">' + hours_plural + '</span>' +
                    '<span class="counter__value">%H</span>' +
                    '</div>' +
                    '<div class="counter">' +
                    '<span class="counter__label">' + minutes_plural + '</span>' +
                    '<span class="counter__value">%M</span>' +
                    '</div>' +
                    '<div class="counter">' +
                    '<span class="counter__label">' + seconds_plural + '</span>' +
