(function ($) {
    $(document).ready(function () {
        $('.stm_upcoming_event__counter .stm_upcoming_event__counter-container').each(function () {
            ...
            var daysCount = Math.round(Math.abs(timeStamp)/86400000/*one day*/);
            $(this).countdown(dateStart, function (event) {
                ...
                let counter = function(type) {
                    ...
                    return '<div class="counter">' +
                        '<span class="counter__label">' + plural + '</span>' +
                        '<span class="counter__value heading_font stc">' + format + '</span>' +
                        '</div>';
                };
