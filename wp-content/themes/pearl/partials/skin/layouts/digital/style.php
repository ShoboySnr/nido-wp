...
.stm_layout_digital.stm_footer_layout_1 .stm-footer {
    padding-top: 57px;
}
...
.stm_layout_digital .stm-footer .footer-widgets aside.widget .tp_recent_tweets {
    margin-top: -5px;
}
.stm_layout_digital .stm-footer .footer-widgets aside.widget .tp_recent_tweets ul li {
    padding-left: 30px;
}
.stm_layout_digital .stm-footer .footer-widgets aside.widget .tp_recent_tweets ul li:before {
    font-size: 16px;
}
.stm_layout_digital .stm-footer .footer-widgets aside.widget .tp_recent_tweets ul li .twitter_time {
    margin-top: 18px;
}
