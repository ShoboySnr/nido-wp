...
.stm_layout_businessfour .stm-footer .stm_material_form.stm_has-value textarea,
.stm_layout_businessfour .stm-footer .stm_material_form.stm_has-value input{
    color: #fff;
}
.stm_layout_businessfour .stm_slider_style_11.stm_slider .stm_slide__overlay .stm_slide__button a,
.stm_layout_businessfour .stm-footer .footer-widgets aside.widget .widgettitle h4, .stmicon-notebook_b,
...
.stm_layout_businessfour .stm-footer .footer-widgets aside.widget .widgettitle h4{
    font-size: 14px;
...
.stm_layout_businessfour .stm-footer .stm_material_form > span{
    color: #a0a0a0;
    font-size: 13px;
    line-height: 24px;
    z-index: 99;
...
.stm_layout_businessfour .stm-footer .stm_material_form.stm_has-value > span, .stm_layout_businessfour .stm-footer .stm_material_form:hover > span{
    opacity: 0;
    z-index: 0;
}
.stm_layout_businessfour .stm-footer .stm_material_form input[type="email"]{
    border: 2px solid #fff !important;
}
.stm_layout_businessfour .stm-footer .stm_material_form:not(.stm_has-value) .form-control{
    background-color: #fff;
}
.stm_layout_businessfour .stm-footer .stm_material_form.stm_has-value .form-control{
