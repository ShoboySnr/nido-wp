...
.stm_layout_creative.stm_footer_layout_1 .stm-footer {
    padding-top: 27px;
}
...
.stm_layout_creative .stm-footer .footer-widgets aside.widget .widgettitle h4 {
    padding: 6px 0 13px;
    text-transform: none !important;
    color: <?php echo wp_kses_post($third_color); ?> !important;
}

.stm_layout_creative .stm-footer .footer-widgets aside.widget .tp_recent_tweets {
    margin-top: -5px;
}
.stm_layout_creative .stm-footer .footer-widgets aside.widget .tp_recent_tweets ul li {
    padding-left: 30px;
}
.stm_layout_creative .stm-footer .footer-widgets aside.widget .tp_recent_tweets ul li:before {
    font-size: 16px;
}
.stm_layout_creative .stm-footer .footer-widgets aside.widget .tp_recent_tweets ul li .twitter_time {
    margin-top: 18px;
}
