...
.stm_footer_layout_2 .stm-footer__bottom .stm_markup > div {
    display: block;
    width: 100%;
    text-align: center;
    font-size: 12px;
    line-height: 24px;
    font-family: <?php echo wp_kses_post($secondary_font['name']) ?>;
}

.stm_footer_layout_2 .stm-footer__bottom .stm_markup .stm_bottom_copyright {
    margin-bottom: 30px;
}

.stm_footer_layout_2 .stm-footer__bottom .stm_markup .stm-socials a {
    margin: 0 10px;
    line-height: 32px;
}

.stm_footer_layout_2 .stm-footer__bottom .stm_markup .stm-socials a:hover {
    background-color: transparent !important;
}

.stm_footer_layout_2 .stm-footer__bottom .stm_markup .stm-socials a i {
    transition: .3s ease;
    font-size: 20px;
    text-indent: 1px;
}
...
body.stm_footer_layout_2 .stm-footer__bottom .stm_markup > div{
    width: auto;
...
body.stm_footer_layout_2 .stm-footer__bottom .stm_markup > .stm_bottom_copyright {
    text-align: right;
    margin-bottom: 0;
}
