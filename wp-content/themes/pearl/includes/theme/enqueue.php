...
if (!is_admin()) {
    ...
    function pearl_load_scripts_and_styles()
    {
        ...
        wp_register_style('stm_rpress', $theme_info['css_vendor'] . 'restropress.css', null, $theme_info['v']);
        ...
        wp_register_script('stm_rpress', $theme_info['js'] . 'restropress.js', array('jquery'), $theme_info['v'], true);
        ...
        if (class_exists('RestroPress')) {
            wp_enqueue_script('stm_rpress');
            wp_enqueue_style('stm_rpress');
        }
